...
<head>
    ...
    <style>
        .gradient-custom {
            ...
            background: -webkit-linear-gradient(to bottom right, rgb(184, 184, 184), rgb(192, 182, 184));

            /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
            background: linear-gradient(to bottom right, rgb(188, 188, 188), rgb(220, 220, 220))
        }
